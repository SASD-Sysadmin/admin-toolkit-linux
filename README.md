...
- file integrity baseline checks and review reporting
...
Create a focused file integrity monitoring review:
...
| Reporting | `scripts/reporting/sasd-run-fim-review.sh` | Run a focused file integrity monitoring review collection. |
...
| Security | `scripts/security/sasd-fim-report.py` | Summarize FIM baselines and check results for human review. |
...
- [docs/fim-review-reporting.md](docs/fim-review-reporting.md)
- [docs/milestone-5-fim-status.md](docs/milestone-5-fim-status.md)
